...
var Tree = ({ node, depth = 0 }) => {
  ...
  return /* @__PURE__ */ import_react2.default.createElement("div", null, /* @__PURE__ */ import_react2.default.createElement("div", { style: { marginLeft: depth * 2 + "rem" } }, /* @__PURE__ */ import_react2.default.createElement("button", { onClick: toggleCollapse, style: {} }, /* @__PURE__ */ import_react2.default.createElement("span", null, isOpen ? "\u25BC" : "\u25B6"), " "), /* @__PURE__ */ import_react2.default.createElement(TreeItem_default, { proof_state: node.proof_state, next_tactic: node.next_tactic })), /* @__PURE__ */ import_react2.default.createElement("div", { hidden: !isOpen }, node.children.map((child, i) => /* @__PURE__ */ import_react2.default.createElement(Tree, { key: child.next_tactic + "/" + depth + "/" + i, node: child, depth: depth + 1 }))));
};
